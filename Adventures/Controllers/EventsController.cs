...
namespace Adventures.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,SportActivityId,LocationId")] Event @event)
        {
            ...
            ViewData["SportActivityId"] = new SelectList(_context.SportActivities, "Id", "Id", @event.SportActivityId);
            return View(@event);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,SportActivityId,LocationId")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdventureContext.Events'  is null.");
            }
            var @event = await _context.Events.FindAsync(id);
            if (@event != null)
            {
